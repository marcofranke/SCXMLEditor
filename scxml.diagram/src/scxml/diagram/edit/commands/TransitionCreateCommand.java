...
public class TransitionCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return ScxmlBaseItemSemanticEditPolicy.getLinkConstraints().canCreateTransition_4001(getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		Transition newElement = ScxmlFactory.eINSTANCE.createTransition();
		getSource().getTransition().add(newElement);
