...
import scxml.diagram.edit.commands.TransitionCreateCommand;
import scxml.diagram.edit.commands.TransitionReorientCommand;
...
import scxml.diagram.edit.parts.ParallelParallelAttrCompartment2EditPart;
import scxml.diagram.edit.parts.ParallelParallelCompartment2EditPart;
 ...
 * @generated
 */
public class Parallel3ItemSemanticEditPolicy extends ScxmlBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public Parallel3ItemSemanticEditPolicy() {
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (ScxmlVisualIDRegistry.getVisualID(incomingLink) == TransitionEditPart.VISUAL_ID) {
		...
		for (Iterator<?> it = view.getSourceEdges().iterator(); it.hasNext();) {
			...
			if (ScxmlVisualIDRegistry.getVisualID(outgoingLink) == TransitionEditPart.VISUAL_ID) {
	...
	*/
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ScxmlElementTypes.Transition_4001 == req.getElementType()) {
