 ...
 * @generated
 */
public class DataModelDataModelCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ScxmlPackage.eINSTANCE.getDataModel_Data();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ScxmlNodeDescriptor> childDescriptors = ScxmlDiagramUpdater
				.getDataModelDataModelCompartment_7031SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return DataEditPart.VISUAL_ID == ScxmlVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ScxmlNodeDescriptor> childDescriptors = ScxmlDiagramUpdater
				.getDataModelDataModelCompartment_7031SemanticChildren((View) getHost().getModel());
