 ...
 * @generated
 */
public class ContentContentCompartment3CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ScxmlPackage.eINSTANCE.getContent_Content();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ScxmlNodeDescriptor> childDescriptors = ScxmlDiagramUpdater
				.getContentContentCompartment_7025SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Content2EditPart.VISUAL_ID == ScxmlVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ScxmlNodeDescriptor> childDescriptors = ScxmlDiagramUpdater
				.getContentContentCompartment_7025SemanticChildren((View) getHost().getModel());
