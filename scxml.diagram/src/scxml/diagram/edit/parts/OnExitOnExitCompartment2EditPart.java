...
import scxml.diagram.edit.policies.OnExitOnExitCompartment2CanonicalEditPolicy;
import scxml.diagram.edit.policies.OnExitOnExitCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OnExitOnExitCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public OnExitOnExitCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OnExitOnExitCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OnExitOnExitCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ScxmlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OnExitOnExitCompartment2CanonicalEditPolicy());
	}
