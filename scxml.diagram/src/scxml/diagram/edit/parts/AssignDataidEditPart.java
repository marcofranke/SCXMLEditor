 ...
 * @generated
 */
public class AssignDataidEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignDataidEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Assign_3005, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.AssignDataidEditPart.VISUAL_ID));
		}
		return parser;
	}
