 ...
 * @generated
 */
public class RaiseEvent2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RaiseEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Raise_3020, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.RaiseEvent2EditPart.VISUAL_ID));
		}
		return parser;
	}
