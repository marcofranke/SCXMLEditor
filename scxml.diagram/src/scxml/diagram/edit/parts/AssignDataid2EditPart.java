 ...
 * @generated
 */
public class AssignDataid2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignDataid2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Assign_3010, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.AssignDataid2EditPart.VISUAL_ID));
		}
		return parser;
	}
