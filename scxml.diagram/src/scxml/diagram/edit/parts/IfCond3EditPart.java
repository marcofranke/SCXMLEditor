 ...
 * @generated
 */
public class IfCond3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfCond3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.If_3027, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.IfCond3EditPart.VISUAL_ID));
		}
		return parser;
	}
