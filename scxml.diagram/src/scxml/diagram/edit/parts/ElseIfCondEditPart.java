 ...
 * @generated
 */
public class ElseIfCondEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ElseIfCondEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.ElseIf_3008, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ElseIfCondEditPart.VISUAL_ID));
		}
		return parser;
	}
