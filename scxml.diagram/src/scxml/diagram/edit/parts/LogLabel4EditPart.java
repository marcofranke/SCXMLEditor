 ...
 * @generated
 */
public class LogLabel4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LogLabel4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Log_3051, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.LogLabel4EditPart.VISUAL_ID));
		}
		return parser;
	}
