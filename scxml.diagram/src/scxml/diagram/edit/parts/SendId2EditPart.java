 ...
 * @generated
 */
public class SendId2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendId2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3021, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendId2EditPart.VISUAL_ID));
		}
		return parser;
	}
