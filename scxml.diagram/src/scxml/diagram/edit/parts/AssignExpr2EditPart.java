 ...
 * @generated
 */
public class AssignExpr2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignExpr2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Assign_3010, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.AssignExpr2EditPart.VISUAL_ID));
		}
		return parser;
	}
