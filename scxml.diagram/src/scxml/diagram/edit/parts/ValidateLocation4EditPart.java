...
import scxml.diagram.edit.policies.ScxmlTextSelectionEditPolicy;
import scxml.diagram.part.ScxmlVisualIDRegistry;
import scxml.diagram.providers.ScxmlElementTypes;
import scxml.diagram.providers.ScxmlParserProvider;

/**
 * @generated
 */
public class ValidateLocation4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValidateLocation4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ScxmlTextSelectionEditPolicy());
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Validate_3055, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ValidateLocation4EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null, ScxmlEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
