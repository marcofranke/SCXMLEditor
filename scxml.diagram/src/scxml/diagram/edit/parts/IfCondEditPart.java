 ...
 * @generated
 */
public class IfCondEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfCondEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.If_3007, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.IfCondEditPart.VISUAL_ID));
		}
		return parser;
	}
