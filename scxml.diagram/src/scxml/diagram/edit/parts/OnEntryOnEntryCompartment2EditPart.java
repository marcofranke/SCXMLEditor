...
import scxml.diagram.edit.policies.OnEntryOnEntryCompartment2CanonicalEditPolicy;
import scxml.diagram.edit.policies.OnEntryOnEntryCompartment2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OnEntryOnEntryCompartment2EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public OnEntryOnEntryCompartment2EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OnEntryOnEntryCompartment2EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OnEntryOnEntryCompartment2ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ScxmlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OnEntryOnEntryCompartment2CanonicalEditPolicy());
	}
