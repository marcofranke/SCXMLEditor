 ...
 * @generated
 */
public class CancelSendidexprEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CancelSendidexprEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Cancel_3006, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.CancelSendidexprEditPart.VISUAL_ID));
		}
		return parser;
	}
