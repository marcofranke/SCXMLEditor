 ...
 * @generated
 */
public class ValidateSchema3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValidateSchema3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Validate_3032, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ValidateSchema3EditPart.VISUAL_ID));
		}
		return parser;
	}
