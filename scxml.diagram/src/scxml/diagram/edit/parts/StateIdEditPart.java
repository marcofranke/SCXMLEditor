 ...
 * @generated
 */
public class StateIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StateIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.State_2001, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.StateIdEditPart.VISUAL_ID));
		}
		return parser;
	}
