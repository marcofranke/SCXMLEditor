...
import scxml.diagram.edit.policies.InitialStateItemSemanticEditPolicy;
...
public class InitialStateEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new InitialStateItemSemanticEditPolicy());
