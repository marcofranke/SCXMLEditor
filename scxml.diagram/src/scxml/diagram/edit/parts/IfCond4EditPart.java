 ...
 * @generated
 */
public class IfCond4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfCond4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.If_3050, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.IfCond4EditPart.VISUAL_ID));
		}
		return parser;
	}
