...
import scxml.diagram.edit.policies.ParallelItemSemanticEditPolicy;
import scxml.diagram.part.ScxmlVisualIDRegistry;

/**
 * @generated
 */
public class ParallelEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParallelIdEditPart) {
			((ParallelIdEditPart) childEditPart).setLabel(getPrimaryShape().getFigureParallelNameFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ParallelParallelCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelAttrCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelAttrCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ParallelParallelAttrCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ParallelParallelCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelCompartmentFigure();
			pane.remove(((ParallelParallelCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelAttrCompartment3EditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelAttrCompartmentFigure();
			pane.remove(((ParallelParallelAttrCompartment3EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof ParallelParallelAttrCompartment3EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(ParallelIdEditPart.VISUAL_ID));
	}
