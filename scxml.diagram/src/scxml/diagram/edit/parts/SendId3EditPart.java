 ...
 * @generated
 */
public class SendId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendId3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3031, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendId3EditPart.VISUAL_ID));
		}
		return parser;
	}
