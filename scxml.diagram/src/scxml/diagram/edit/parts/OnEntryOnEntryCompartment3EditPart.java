...
import scxml.diagram.edit.policies.OnEntryOnEntryCompartment3CanonicalEditPolicy;
import scxml.diagram.edit.policies.OnEntryOnEntryCompartment3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OnEntryOnEntryCompartment3EditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public OnEntryOnEntryCompartment3EditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OnEntryOnEntryCompartment3EditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OnEntryOnEntryCompartment3ItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ScxmlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OnEntryOnEntryCompartment3CanonicalEditPolicy());
	}
