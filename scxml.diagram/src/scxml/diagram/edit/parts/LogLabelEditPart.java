 ...
 * @generated
 */
public class LogLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public LogLabelEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Log_3013, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.LogLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
