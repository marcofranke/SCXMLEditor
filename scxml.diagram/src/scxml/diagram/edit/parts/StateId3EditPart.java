 ...
 * @generated
 */
public class StateId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StateId3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.State_3039, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.StateId3EditPart.VISUAL_ID));
		}
		return parser;
	}
