 ...
 * @generated
 */
public class DataExprEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataExprEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Data_3061, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.DataExprEditPart.VISUAL_ID));
		}
		return parser;
	}
