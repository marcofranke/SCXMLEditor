...
import scxml.diagram.edit.policies.AssignItemSemanticEditPolicy;
...
public class AssignEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new AssignItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AssignDataidEditPart) {
			((AssignDataidEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignDataidFigure());
			return true;
		}
		if (childEditPart instanceof AssignExprEditPart) {
			((AssignExprEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignExprFigure());
			return true;
		}
		if (childEditPart instanceof AssignLocationEditPart) {
			((AssignLocationEditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignLocationFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(AssignDataidEditPart.VISUAL_ID));
	}
