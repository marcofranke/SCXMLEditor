 ...
 * @generated
 */
public class SendEvent3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendEvent3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3031, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendEvent3EditPart.VISUAL_ID));
		}
		return parser;
	}
