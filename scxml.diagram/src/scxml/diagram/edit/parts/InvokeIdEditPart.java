 ...
 * @generated
 */
public class InvokeIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public InvokeIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Invoke_3045, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.InvokeIdEditPart.VISUAL_ID));
		}
		return parser;
	}
