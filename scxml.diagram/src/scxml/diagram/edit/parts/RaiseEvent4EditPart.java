 ...
 * @generated
 */
public class RaiseEvent4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RaiseEvent4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Raise_3053, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.RaiseEvent4EditPart.VISUAL_ID));
		}
		return parser;
	}
