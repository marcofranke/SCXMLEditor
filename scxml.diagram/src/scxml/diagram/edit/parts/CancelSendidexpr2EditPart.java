 ...
 * @generated
 */
public class CancelSendidexpr2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CancelSendidexpr2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Cancel_3011, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.CancelSendidexpr2EditPart.VISUAL_ID));
		}
		return parser;
	}
