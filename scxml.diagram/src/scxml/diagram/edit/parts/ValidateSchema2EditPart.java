 ...
 * @generated
 */
public class ValidateSchema2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValidateSchema2EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Validate_3022, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ValidateSchema2EditPart.VISUAL_ID));
		}
		return parser;
	}
