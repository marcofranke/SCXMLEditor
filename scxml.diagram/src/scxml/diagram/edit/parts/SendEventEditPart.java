 ...
 * @generated
 */
public class SendEventEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3016, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendEventEditPart.VISUAL_ID));
		}
		return parser;
	}
