 ...
 * @generated
 */
public class ParallelIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParallelIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Parallel_2004, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParallelIdEditPart.VISUAL_ID));
		}
		return parser;
	}
