 ...
 * @generated
 */
public class ParallelId3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParallelId3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Parallel_3038, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParallelId3EditPart.VISUAL_ID));
		}
		return parser;
	}
