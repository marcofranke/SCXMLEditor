 ...
 * @generated
 */
public class DataSrcEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataSrcEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Data_3061, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.DataSrcEditPart.VISUAL_ID));
		}
		return parser;
	}
