 ...
 * @generated
 */
public class CancelSendidEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CancelSendidEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Cancel_3006, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.CancelSendidEditPart.VISUAL_ID));
		}
		return parser;
	}
