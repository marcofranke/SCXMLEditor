 ...
 * @generated
 */
public class HistoryStateIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HistoryStateIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.HistoryState_3043, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.HistoryStateIdEditPart.VISUAL_ID));
		}
		return parser;
	}
