 ...
 * @generated
 */
public class SendEvent2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendEvent2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3021, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendEvent2EditPart.VISUAL_ID));
		}
		return parser;
	}
