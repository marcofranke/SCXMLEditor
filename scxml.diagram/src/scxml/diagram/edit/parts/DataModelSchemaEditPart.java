 ...
 * @generated
 */
public class DataModelSchemaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataModelSchemaEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.DataModel_2005, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.DataModelSchemaEditPart.VISUAL_ID));
		}
		return parser;
	}
