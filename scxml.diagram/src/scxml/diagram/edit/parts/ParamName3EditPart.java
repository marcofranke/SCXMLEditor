 ...
 * @generated
 */
public class ParamName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParamName3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Param_3029, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParamName3EditPart.VISUAL_ID));
		}
		return parser;
	}
