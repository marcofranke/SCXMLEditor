 ...
 * @generated
 */
public class CancelSendidexpr4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CancelSendidexpr4EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Cancel_3049, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.CancelSendidexpr4EditPart.VISUAL_ID));
		}
		return parser;
	}
