 ...
 * @generated
 */
public class StateId2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public StateId2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.State_3001, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.StateId2EditPart.VISUAL_ID));
		}
		return parser;
	}
