 ...
 * @generated
 */
public class DataIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DataIdEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Data_3061, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.DataIdEditPart.VISUAL_ID));
		}
		return parser;
	}
