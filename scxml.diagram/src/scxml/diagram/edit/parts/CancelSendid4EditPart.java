 ...
 * @generated
 */
public class CancelSendid4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CancelSendid4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Cancel_3049, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.CancelSendid4EditPart.VISUAL_ID));
		}
		return parser;
	}
