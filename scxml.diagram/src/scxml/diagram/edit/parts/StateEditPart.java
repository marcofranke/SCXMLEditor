...
import scxml.diagram.edit.policies.StateItemSemanticEditPolicy;
...
public class StateEditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StateIdEditPart) {
			((StateIdEditPart) childEditPart).setLabel(getPrimaryShape().getFigureStateIdFigure());
			return true;
		}
		if (childEditPart instanceof StateStateCompartmentEditPart) {
			...
			pane.add(((StateStateCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof StateStateAttrCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentAttrFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((StateStateAttrCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StateStateCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentFigure();
			pane.remove(((StateStateCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof StateStateAttrCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentAttrFigure();
			pane.remove(((StateStateAttrCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof StateStateAttrCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(StateIdEditPart.VISUAL_ID));
	}
