 ...
 * @generated
 */
public class ParallelId2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParallelId2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Parallel_3037, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParallelId2EditPart.VISUAL_ID));
		}
		return parser;
	}
