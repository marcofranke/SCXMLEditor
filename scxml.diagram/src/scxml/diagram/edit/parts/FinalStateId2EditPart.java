 ...
 * @generated
 */
public class FinalStateId2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FinalStateId2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.FinalState_3002, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.FinalStateId2EditPart.VISUAL_ID));
		}
		return parser;
	}
