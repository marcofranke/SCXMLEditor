 ...
 * @generated
 */
public class HistoryStateId2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public HistoryStateId2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.HistoryState_3057, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.HistoryStateId2EditPart.VISUAL_ID));
		}
		return parser;
	}
