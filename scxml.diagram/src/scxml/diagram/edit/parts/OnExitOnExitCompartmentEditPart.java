...
import scxml.diagram.edit.policies.OnExitOnExitCompartmentCanonicalEditPolicy;
import scxml.diagram.edit.policies.OnExitOnExitCompartmentItemSemanticEditPolicy;
 ...
 * @generated
 */
public class OnExitOnExitCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	* @generated
	*/
	public OnExitOnExitCompartmentEditPart(View view) {
		super(view);
	}
	...
	*/
	public String getCompartmentName() {
		return Messages.OnExitOnExitCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new OnExitOnExitCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(ScxmlVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new OnExitOnExitCompartmentCanonicalEditPolicy());
	}
