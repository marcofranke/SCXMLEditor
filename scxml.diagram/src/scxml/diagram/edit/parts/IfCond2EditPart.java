 ...
 * @generated
 */
public class IfCond2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IfCond2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.If_3012, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.IfCond2EditPart.VISUAL_ID));
		}
		return parser;
	}
