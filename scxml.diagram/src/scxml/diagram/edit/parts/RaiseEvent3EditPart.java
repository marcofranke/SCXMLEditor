 ...
 * @generated
 */
public class RaiseEvent3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RaiseEvent3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Raise_3030, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.RaiseEvent3EditPart.VISUAL_ID));
		}
		return parser;
	}
