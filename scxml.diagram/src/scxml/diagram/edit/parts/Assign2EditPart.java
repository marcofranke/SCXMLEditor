...
import scxml.diagram.edit.policies.Assign2ItemSemanticEditPolicy;
...
public class Assign2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Assign2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AssignDataid2EditPart) {
			((AssignDataid2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignDataidFigure());
			return true;
		}
		if (childEditPart instanceof AssignExpr2EditPart) {
			((AssignExpr2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignExprFigure());
			return true;
		}
		if (childEditPart instanceof AssignLocation2EditPart) {
			((AssignLocation2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignLocationFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(AssignDataid2EditPart.VISUAL_ID));
	}
