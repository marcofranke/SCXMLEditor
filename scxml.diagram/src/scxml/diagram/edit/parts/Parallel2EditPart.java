...
import scxml.diagram.edit.policies.Parallel2ItemSemanticEditPolicy;
import scxml.diagram.part.ScxmlVisualIDRegistry;

/**
 * @generated
 */
public class Parallel2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Parallel2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Parallel2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ParallelId2EditPart) {
			((ParallelId2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureParallelNameFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ParallelParallelCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelAttrCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelAttrCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ParallelParallelAttrCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ParallelParallelCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelCompartmentFigure();
			pane.remove(((ParallelParallelCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof ParallelParallelAttrCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getFigureParallelAttrCompartmentFigure();
			pane.remove(((ParallelParallelAttrCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof ParallelParallelAttrCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(ParallelId2EditPart.VISUAL_ID));
	}
