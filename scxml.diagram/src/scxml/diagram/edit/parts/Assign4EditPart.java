...
import scxml.diagram.edit.policies.Assign4ItemSemanticEditPolicy;
...
public class Assign4EditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Assign4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AssignDataid4EditPart) {
			((AssignDataid4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignDataidFigure());
			return true;
		}
		if (childEditPart instanceof AssignExpr4EditPart) {
			((AssignExpr4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignExprFigure());
			return true;
		}
		if (childEditPart instanceof AssignLocation4EditPart) {
			((AssignLocation4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureAssignLocationFigure());
			return true;
		}
		return false;
	}
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(AssignDataid4EditPart.VISUAL_ID));
	}
