 ...
 * @generated
 */
public class ValidateSchemaEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValidateSchemaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Validate_3017, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ValidateSchemaEditPart.VISUAL_ID));
		}
		return parser;
	}
