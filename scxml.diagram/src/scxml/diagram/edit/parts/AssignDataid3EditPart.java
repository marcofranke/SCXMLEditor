 ...
 * @generated
 */
public class AssignDataid3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignDataid3EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Assign_3025, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.AssignDataid3EditPart.VISUAL_ID));
		}
		return parser;
	}
