 ...
 * @generated
 */
public class FinalStateIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public FinalStateIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.FinalState_2002, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.FinalStateIdEditPart.VISUAL_ID));
		}
		return parser;
	}
