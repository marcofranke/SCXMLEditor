 ...
 * @generated
 */
public class AssignDataid4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AssignDataid4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Assign_3048, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.AssignDataid4EditPart.VISUAL_ID));
		}
		return parser;
	}
