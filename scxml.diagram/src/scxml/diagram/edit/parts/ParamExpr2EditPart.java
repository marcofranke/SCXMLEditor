 ...
 * @generated
 */
public class ParamExpr2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParamExpr2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Param_3019, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParamExpr2EditPart.VISUAL_ID));
		}
		return parser;
	}
