 ...
 * @generated
 */
public class RaiseEventEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public RaiseEventEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Raise_3015, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.RaiseEventEditPart.VISUAL_ID));
		}
		return parser;
	}
