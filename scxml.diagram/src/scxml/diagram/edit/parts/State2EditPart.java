...
import scxml.diagram.edit.policies.State2ItemSemanticEditPolicy;
...
public class State2EditPart extends ShapeNodeEditPart {
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof StateId2EditPart) {
			((StateId2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureStateIdFigure());
			return true;
		}
		if (childEditPart instanceof StateStateCompartment2EditPart) {
			...
			pane.add(((StateStateCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof StateStateAttrCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentAttrFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((StateStateAttrCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof StateStateCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentFigure();
			pane.remove(((StateStateCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		if (childEditPart instanceof StateStateAttrCompartment2EditPart) {
			IFigure pane = getPrimaryShape().getFigureStateCompartmentAttrFigure();
			pane.remove(((StateStateAttrCompartment2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		...
		if (editPart instanceof StateStateAttrCompartment2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(ScxmlVisualIDRegistry.getType(StateId2EditPart.VISUAL_ID));
	}
