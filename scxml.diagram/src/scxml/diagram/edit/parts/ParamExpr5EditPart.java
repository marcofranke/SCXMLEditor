 ...
 * @generated
 */
public class ParamExpr5EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ParamExpr5EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Param_3046, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ParamExpr5EditPart.VISUAL_ID));
		}
		return parser;
	}
