 ...
 * @generated
 */
public class SendIdEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendIdEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3016, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendIdEditPart.VISUAL_ID));
		}
		return parser;
	}
