 ...
 * @generated
 */
public class SendId4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SendId4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Send_3054, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.SendId4EditPart.VISUAL_ID));
		}
		return parser;
	}
