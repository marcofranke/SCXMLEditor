 ...
 * @generated
 */
public class TransitionEventEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.TransitionEventEditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Transition_4001, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.TransitionEventEditPart.VISUAL_ID));
		}
		return parser;
	}
