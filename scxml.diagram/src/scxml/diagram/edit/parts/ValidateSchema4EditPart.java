 ...
 * @generated
 */
public class ValidateSchema4EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ValidateSchema4EditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ScxmlParserProvider.getParser(ScxmlElementTypes.Validate_3055, getParserElement(),
					ScxmlVisualIDRegistry.getType(scxml.diagram.edit.parts.ValidateSchema4EditPart.VISUAL_ID));
		}
		return parser;
	}
