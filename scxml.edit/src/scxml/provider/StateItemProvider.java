...
/**
 * This is the item provider adapter for a {@link scxml.State} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScxmlPackage.Literals.STATE__ONENTRY);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__ONEXIT);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__INITIAL);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__STATE);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__FINAL);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__PARALLEL);
			childrenFeatures.add(ScxmlPackage.Literals.STATE__HISTORY);
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__ONENTRY,
				 ScxmlFactory.eINSTANCE.createOnEntry()));

		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__ONEXIT,
		...
		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__STATE,
				 ScxmlFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__FINAL,
				 ScxmlFactory.eINSTANCE.createFinalState()));

		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__PARALLEL,
				 ScxmlFactory.eINSTANCE.createParallel()));

		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.STATE__HISTORY,
