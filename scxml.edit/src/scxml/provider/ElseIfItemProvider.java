...
/**
 * This is the item provider adapter for a {@link scxml.ElseIf} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElseIfItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElseIf_cond_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElseIf_cond_feature", "_UI_ElseIf_type"),
				 ScxmlPackage.Literals.ELSE_IF__COND,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((ElseIf)object).getCond();
		return label == null || label.length() == 0 ?
			getString("_UI_ElseIf_type") :
			getString("_UI_ElseIf_type") + " " + label;
	}
