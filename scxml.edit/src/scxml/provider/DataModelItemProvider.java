...
/**
 * This is the item provider adapter for a {@link scxml.DataModel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataModelItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataModel_schema_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataModel_schema_feature", "_UI_DataModel_type"),
				 ScxmlPackage.Literals.DATA_MODEL__SCHEMA,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ScxmlPackage.Literals.DATA_MODEL__DATA);
		}
	...
	public String getText(Object object) {
		String label = ((DataModel)object).getSchema();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ScxmlPackage.Literals.DATA_MODEL__DATA,
				 ScxmlFactory.eINSTANCE.createData()));
	}
