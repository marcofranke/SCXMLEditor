 ...
 * </p>
 * <ul>
 *   <li>{@link scxml.impl.ContentImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ContentImpl extends MinimalEObjectImpl.Container implements Content {
	...
	public EList<Content> getContent() {
		if (content == null) {
			content = new EObjectContainmentEList<Content>(Content.class, this, ScxmlPackage.CONTENT__CONTENT);
		}
		return content;
	}
